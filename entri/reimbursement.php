		...
		if($v!="") {
			$sql = "
				SELECT	nomorprk, nomorscore, nomorskki noskk, nilaianggaran anggaran, nilaidisburse disburse, 
						DATE_FORMAT(tanggalskki, '%d-%m-%Y') as tanggalskki, b.namaunit, namapos, nomorkontrak, 
						k.vendor, k.uraian uraiank, DATE_FORMAT(tglawal, '%d-%m-%Y') as tglawal, tglbayar, pmn, 
						DATE_FORMAT(tglakhir, '%d-%m-%Y') as tglakhir, nilaikontrak, nilaibayar, 
						COALESCE(nodokumen, nodokrep) as nodokumen,
