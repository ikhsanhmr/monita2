	...
	<form name='tambahrekomendasi' method=POST id='tambahrekomendasi' action="proseseditskko.php" autocomplete="off" onsubmit="return ndvalidate(0)">
		<table>
			...
			<tr>
				<td>Nilai WBS</td>
				<td>
					<input name="wbs" id="wbs" maxlength="64" size="50" type="text" value="<?php echo $wbs; ?>" />
			...
			<tr>
				<td>Nilai Tunai</td>
				<td>
					<input name="tunai" id="tunai" maxlength="64" size="50" type="text" onchange="anggaranval();" value="<?php echo $tunai; ?>" />
					<!--onchange="formatme(this)"-->
				</td>
			</tr>
			<tr>
				...
				<td>
					<input name="nontunai" id="nontunai" maxlength="64" size="50" type="text" onchange="anggaranval();" value="<?php echo $nontunai; ?>" />
					<!--onchange="formatme(this)"-->
				</td>
			</tr>
			<tr>
				...
				<td>
					<input name="anggaran" id="anggaran" maxlength="64" size="50" type="text" readonly value="<?php echo $anggaran; ?>" />
					<!--onchange="formatme(this)"-->
				</td>
			</tr>
			<tr>
				...
				<td>
					<input name="disburse" id="disburse" maxlength="64" size="50" type="text" readonly value="<?php echo $disburse; ?>" />
					<!--onchange="formatme(this)"-->
				</td>
			</tr>
			<?php
