...
//	$parm .= ($p2==""? "": " and SUBSTR(tanggalskki, 1, 7) <= '$p2'");
	...
	if($v!="") {
			...
			$sql = "
				SELECT	n.nomornota, nipuser, g.id userid, pelaksana, b.namaunit, pos1, nilai1, namapos, nomorwbs, nomorprk, 
						...
						s.nilaianggaransl1, s.nilaianggaransl3, s.nilaianggarankp
				FROM 	notadinas n LEFT JOIN 
						...
						rab rb ON k.no_rab = rb.no_rab LEFT JOIN asetpdp pdp ON k.nomorkontrak = pdp.nomorkontrak
				WHERE 	d.progress >= 7 AND NOT nomorskki IS NULL 
				$parm
