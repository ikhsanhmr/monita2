<?php
	...
	*/
	...
	if($v!="") {
			$sql = "
				SELECT 	n.nomornota nd, skk, pos1, nomorkontrak, b.namaunit, vendor, oi.uraian oiuraian, 
						nodokumen, nilaikontrak, bayar, catatan, catatanreject
				...
				WHERE n.progress = 7 AND COALESCE(oi.skk, '') != '' AND NOT nomorkontrak IS NULL 
					$parm
