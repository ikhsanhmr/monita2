...
<head>
	...
	<script type="text/javascript">
		function viewk(me) {
			...
			var url = encodeURI((me==undefined? "index.php": "kontrakxl.php") + "?p1="+p1+"&p2="+p2+"&b="+b+"&p="+p+"&k="+k+"&o="+o+"&c="+c+"&v=1");
...
<body>
	<?php
		...
		echo "
			<h2>Data Kontrak Mendekati Jatuh Tempo Wilayah Sumatera Utara</h2>
			<table>
				<tr>
...
*/
			...
			$sql = "
				...
				--	nomorskko skk, tanggalskko tglskk,
					skk, tglskk,
					inputdt, nomorkontrak, vendor, k.uraian uraiank, tglawal, tglakhir, nilaikontrak, bayar 
				FROM notadinas n
				LEFT JOIN bidang g ON n.nipuser = g.nick 
				LEFT JOIN notadinas_detail d ON n.nomornota = d.nomornota
				LEFT JOIN bidang b ON d.pelaksana = b.id  
				...
				LEFT JOIN (
					SELECT nomorskko skk, tanggalskko tglskk FROM skkoterbit UNION
					SELECT nomorskki skk, tanggalskki tglskk FROM skkiterbit 
				)s ON d.noskk = s.skk
				...
				AND tglakhir BETWEEN  CONCAT('$p1','-01')  AND CONCAT('$p2','-30')
				$parm
