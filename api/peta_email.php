	...
	while ($row = mysqli_fetch_array($query_result)) {
            ...
            <table style="border-collapse: collapse; width: 100%; height: 270px;" border="1">
                ...
                <tbody>
                    ...
                    <tr style="height: 18px;">
                        ...
                        <td style="width: 40.7836%; text-align: center; height: 18px;">
                            <ul style="list-style-type: circle;">
                                ...
                                <li class="m_7929123103862784736MsoListParagraph" style="text-align: left;"><span style="font-size: 8pt; font-family: verdana, geneva;">PTL, Sewa Kit, BBM KIT, Har Instalasi dan KIT: Inda Ardini</span></li>
                    ...
                    <tr style="height: 18px;">
                        ...
                        <td style="width: 40.7836%; text-align: center; height: 18px;"><span style="font-size: 8pt;">Pesta Toman Lumbanbatu</span></td>
        ...
        $textcontent = '
            ...
            2. Kanwil Operasi \n
                ...
                \t \t PTL, Sewa Kit, BBM KIT, Har Instalasi dan KIT: Inda Ardini \n
            ...
            5. UP3 Binjai \n
                \t PIC Anggaran: Pesta Toman Lumbanbatu \n
        ...
        $to         = "";
        $cc         = "Merry <merry@pln.co.id>, Fadlul <fadlul.fathoni@gmail.com>";
        ...
        if ($p0 > 5) {
            ...
            $sql_user   = "SELECT * FROM user WHERE kodeorg = $p0 and active = 1";
		...
		if ($p0 < 6){
			...
			$sql_user   = "select * from user where roleid IN (02,03) or nip IN ('7194002A','8409029A','8509035A','8106282Z') and active = 1";
        
		}else{
			
			$sql_user   = "select * from akses_bidang a inner join user b on a.nip = b.nip where a.akses = $p0 and roleid IN (02,03,04,05) and b.active = 1";
		}
		...
		if (empty($to)){
			...
			$to .= "Haris Jhon Horas <haris.john@pln.co.id>, Ricky Panggabean <ricky.pangabean@pln.co.id>, Merry <merry@pln.co.id>, Fadlul <fadlul.fathoni@gmail.com>";
