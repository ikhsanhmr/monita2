		...
		foreach($no as $id) {
			...
			if ($sukses != 1){
				...
				if ($lvl == 4 && $t == 1){
					...
					mysqli_query("insert into realisasibayar(nokontrak, nodokrep, nilaibayar, tglbayar, pmn, keterangan) values('$k', '$exekontrak[nodokumen]', '$tgh', sysdate(), '$pmn', '$ctt')");
				}
			}
