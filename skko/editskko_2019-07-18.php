...
<form name='tambahrekomendasi' method=POST id='tambahrekomendasi' action="proseseditskko.php" autocomplete="off" onsubmit="return ndvalidate(0)">
  <table>
      <tr>
		   ...
		   <tr>
            <td>Nomor SKKO</td>                
            <td><input name="noskko" id="noskko" maxlength="64" size="50" type="text" value="<?=$noskko;?>" />
            </td>
        </tr>   
        <tr>
            <td>Tgl Terbit SKKO</td>                  
            <td><input name="tgl_skko" id="tgl_skko" type="text" size="50" value="<?=$tgl_skko;?>" /></td>
            </tr>  
        <tr>
            <td>Uraian</td>                    
        ...
        <td>Jenis</td>                    
            <td><select name="jenis" id="jenis">
             <option value=''>Pilih Jenis</option>            
                    ...
                    <option value='NON RUTIN' <?=($jenis=="NON RUTIN"? "selected": "");?> >NON RUTIN</option>
              </select></td>        
         </tr> 
    <tr>
            ...
            <td>            
                <div>
                  <input name="nocostcenter" id="nocostcenter" maxlength="64" size="50" type="text" onkeyup="lookup(this.value);" onblur="fill();" value="<?=$nocostcenter;?>" />
                </div>
    ...
    <tr>
            <td>No WBS</td>                    
            <td>            
            <input name="nowbs" id="nowbs" maxlength="64" size="50" type="text" value="<?=$nowbs;?>" />
            </td>
        </tr> 
        <tr>
            <td>Nilai WBS</td>                    
            <td>            
            <input name="wbs" id="wbs" maxlength="64" size="50" type="text" value="<?=$wbs;?>" /> <!--onchange="formatme(this)"-->
            </td>
        </tr>                         
        <tr>
            <td>Nilai Tunai</td>                    
            <td>            
            <input name="tunai" id="tunai" maxlength="64" size="50" type="text" onchange="anggaranval();" value="<?=$tunai;?>" /> <!--onchange="formatme(this)"-->
            </td>
        </tr>
        <tr>
            <td>Nilai Non Tunai</td>                    
            <td>            
            <input name="nontunai" id="nontunai" maxlength="64" size="50" type="text" onchange="anggaranval();" value="<?=$nontunai;?>" /> <!--onchange="formatme(this)"-->
            </td>
        </tr>
        <tr>
            <td>Nilai Anggaran</td>                    
            <td>            
            <input name="anggaran" id="anggaran" maxlength="64" size="50" type="text" readonly value="<?=$anggaran;?>" /> <!--onchange="formatme(this)"-->
            </td>
        </tr>
        <tr>
            <td>Nilai Disburse</td>                    
            <td>            
            <input name="disburse" id="disburse" maxlength="64" size="50" type="text" readonly value="<?=$disburse;?>" /> <!--onchange="formatme(this)"-->
            </td>
        </tr>
<?php
/*
