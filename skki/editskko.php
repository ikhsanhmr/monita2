...
$sql = "
	SELECT s.*, n.nomornota nota, pelaksana, n.nid, pos1, nilai1, progress, sisa1, namaunit unit FROM " .
		...
		<table>
			...
			<tr>
				<td align="center">
					...
					<input type="button" name="btn" id="btn" onclick="tambahedit('<?php echo $noskki; ?>')" value="+">
				</td>
				<td>
					<div id="mydiv"></div>
					<?php echo $rslt; ?>
			...
			<tr>
				...
				<td>
					<!-- <textarea name="aset" id="aset" rows="3" cols="50"></textarea> -->
					<table border="0">
						<tr>
			...
			<tr>
				<td>Nilai Tunai</td>
				<td>
					<input value="<?php echo $tunai; ?>" name="tunai" id="tunai" maxlength="64" size="50" type="text" onchange="anggaranval();" />
					<!--onchange="formatme(this)"-->
				</td>
			</tr>
			<tr>
				<td>Nilai Non Tunai</td>
				<td>
					<input value="<?php echo $nontunai; ?>" name="nontunai" id="nontunai" maxlength="64" size="50" type="text" onchange="anggaranval();" />
					<!--onchange="formatme(this)"-->
				</td>
			</tr>
			<tr>
				...
				<td>
					<input value="<?php echo $anggaran; ?>" name="anggaran" id="anggaran" maxlength="64" size="50" type="text" readonly />
					<!--onchange="formatme(this)"-->
				</td>
			</tr>
			<tr>
				...
				<td>
					<input value="<?php echo $disburse; ?>" name="disburse" id="disburse" maxlength="64" size="50" type="text" readonly />
					<!--onchange="formatme(this)"-->
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>Nilai WBS</td>
				<td>
					<input value="<?php echo $wbs; ?>" name="wbs" id="wbs" maxlength="64" size="50" type="text" />
					<!--onchange="formatme(this)"-->
				</td>
			</tr>
