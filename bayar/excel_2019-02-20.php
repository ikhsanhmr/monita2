...
//		$parm .= ($p2==""? "": " and SUBSTR(tglbayar, 1, 7) <= '$p2'"); //
	...
	if($v!="") {
		...
		$sql = "
			SELECT 
					n.skkoi skkoi, nipuser, g.id iduser, pelaksana, b.namaunit, skk, pos1, namapos, k.nomorkontrak, k.uraian uraiank, k.tglawal tglmulai, k.tglakhir tglakhir, k.nilaikontrak nilaikontrak, nilaibayar, tglbayar, bayarid, aset.jtmaset jtma, aset.jtraset jtra, aset.gdaset gda, s.nomorprk prk, s.nomorscore score, s.nilaitunai nilaiskk, s.tanggalskki tanggalterbit, s.posinduk posinduk, unit.namaunit nmunit
				FROM (
