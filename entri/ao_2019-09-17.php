...
//		$parm .= ($p2==""? "": " and SUBSTR(tanggalskko, 1, 7) <= '$p2'");
		...
		if($v!="") {
			$sql = "
				SELECT	n.nomornota, nipuser, pelaksana, b.namaunit, pos1, nilai1, namapos, nomorwbs, vendor, 
						nomorcostcenter, nomorskko noskk, s.uraian uraians, nilaianggaran anggaran, nilaiwbs wbs, 
						...
						DATE_FORMAT(inputdt, '%d-%m-%Y %H:%i:%s') as inputdt, k.nomorkontrak, 
