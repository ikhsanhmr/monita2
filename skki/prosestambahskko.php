...
//		$aset = trim($_POST['aset']);
		...
		$sql = "
			INSERT INTO skkiterbit(
				nomorprk, nomorscore, posinduk, nomorskki, uraian, tanggalskki, nilaitunai, nilainontunai, nilaianggaran, 
				nilaidisburse, nomorwbs, nilaiwbs, jtm, nilaianggaranjtm, nilaidisbursejtm, gd, nilaianggarangd, 
				nilaidisbursegd, jtr, nilaianggaranjtr, nilaidisbursejtr, sl1, nilaianggaransl1, nilaidisbursesl1, sl3, 
				nilaianggaransl3, nilaidisbursesl3, nip, keypoint, nilaianggarankp, nilaidisbursekp)
			VALUES (
				'$noprk', '$basket', '$pos0', '$noskki', '$uraian', '$tgl_skki', '$tunai', '$nontunai', '$anggaran', 
				'$disburse', '$nowbs', '$wbs', '$jtm', '$jtma', '$jtmd', '$gd', '$gda', 
