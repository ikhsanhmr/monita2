		...
		if($v!="") {
			$sql = "
				SELECT 
					...
					nomorwbs, nomorprk, nomorscore, nomorskki noskk, s.uraian uraians, tanggalskki, DATEDIFF(SYSDATE(), tanggalskki) umur, nilaianggaran anggaran, nilaidisburse disburse, nilaiwbs wbs, 
