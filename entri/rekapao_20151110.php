	...
	echo "
		...
		<table border='1'>
			<tr>
				...
				<th colspan='10' scope='col'>SKKO Terbit</th>
			...
			<tr>
				...
				<td align='center' rowspan='2' style='background-color:rgb(127,255,127)'>WBS/Cost Center (Rp.)</td>
...
//			$diskon = $row["nilaidisburse"]; 
			...
			<tr>
				...
				<td align='right'><div id='sisko$no'></div></td>
				<td align='right'><div id='siskon$no'></div></td>
				<td></td>
			</tr>";
			...
			if($no>1) {
				...
				echo "<script>document.getElementById('konp$num').innerHTML = '". number_format($nkon/$ndis0*100,2) . "'</script>";
				echo "<script>document.getElementById('bay$num').innerHTML = '". number_format($nbay) . "'</script>";
				echo "<script>document.getElementById('bayp$num').innerHTML = '". number_format($nbay/$nkon*100,2) . "'</script>";
				echo "<script>document.getElementById('sisko$num').innerHTML = '". number_format($ndis0-$nkon) . "'</script>";
				echo "<script>document.getElementById('siskon$num').innerHTML = '". number_format($nkon-$nbay) . "'</script>";
			}

			$npos = 0;
			$nkon = 0;
			$nbay = 0;
			$ndis0 = $row["nilaidisburse"];
		...
		echo "
			<tr>
				...
				<td align='right'>".number_format($row["nilaikontrak"]/$row["nilai1"]*100,2)."</td>
				<td align='right'>".number_format($row["nilaibayar"])."</td>
				<td align='right'>".number_format($row["nilaibayar"]/$row["nilaikontrak"]*100,2)."</td>
				<td align='right'>".number_format($row["nilai1"]-$row["nilaikontrak"])."</td>
