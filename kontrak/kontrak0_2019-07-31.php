									...
									<tr>
										...
										<td>
											<select class='rutinselect' style='display:none;' name='rutin0' data-id='0'>
												<option value='0'>Non Rutin</option>
												<option value='1'>Rutin</option>
											</select>

											<span class='rutininfo' id='rutininfo0' style='display:none;'>Manbil, Manbuild, Yantek, Yanti, PTL - IPP, Rumah Sakit, Apotik, Dokter, dll</span>
										</td>
									</tr>
									<tr id='rabOpen'>
