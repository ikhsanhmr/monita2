				...
				while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
					...
					$parm .= "
						<tr>
							...
							<td>:</td>
							<td><input step='any' type='number' name='nilai$no' id='nilai$no' value='$row[nilai1]'></td>
						</tr>
						";
					...
					if($row["jenis"] == "SKKI"){
						...
						$inputbasket .= "
							<tr>
								<th>Basket</th>
								<td>:</td>
								<td><input name='basket' id='basket' maxlength='64' size='50' type='text' value='$basket'></td>
							</tr>
						";
					}
				}
