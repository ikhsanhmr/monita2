			...
			<form name='frab' id='frab' method='post' action='simpan.php'>
				<table border='1'>
					...
					<tr>
						<td>Nomor RAB </td>
						<td>&nbsp;:&nbsp;</td>
						<td><input type='text' name='norab' placeholder='Entry Nomor RAB'></td>
					</tr>
					<tr>
						<td>Nilai </td>
						<td>&nbsp;:&nbsp;</td>
						<td><input type='text' name='nilai' placeholder='Entry Nilai'></td>
					</tr>
					<tr>
						<td>Tanggal RAB </td>
						<td>&nbsp;:&nbsp;</td>
						<td><input type='date' name='tanggalrab'></td>
					</tr>
					<tr>
