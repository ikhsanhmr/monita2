...
$hasil = mysqli_query($mysqli, $sql) or die('Unable to execute query. ' . mysqli_error($mysqli)) or die(mysqli_error($mysqli, $sql));
    ...
    <form name='editcostcenter' method=POST id='editcostcenter' action="proseseditcostcenter.php" autocomplete="off">
        ...
        <table>
            ...
            <tr>
                ...
                <td><input name="hierarchyarea" id="hierarchyarea" maxlength="64" size="50" type="text" value="<?= $hierarkiarea; ?>" />
                </td>
            </tr>
            <tr>
                <td>Uraian</td>
                <td><input name="uraian" id="uraian" type="text" size="50" value="<?= $uraian; ?>" /></td>
            </tr>
            <tr>
                <td>Cost Center</td>
                <td>
                    <input name="costcenter" id="costcenter" maxlength="64" size="50" type="text" value="<?= $nocostcenterawal; ?>" />
                </td>
            </tr>
            <tr>
                <td>Description Business Area</td>
                <td>
                    <input name="deskripsibisnisarea" id="deskripsibisnisarea" maxlength="64" size="50" type="text" value="<?= $descriptionbisnis; ?>" />
                </td>
            </tr>
            <tr>
                <td>Business Area</td>
                <td>
                    <input name="bisnisarea" id="bisnisarea" maxlength="64" size="50" type="text" value="<?= $bisnisarea; ?>" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
