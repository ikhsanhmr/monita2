...
<form name='tambahrekomendasi' method="POST" id='tambahrekomendasi' action="proseseditskko.php" autocomplete="off" onsubmit="return ndvalidate(0)">
  <table>
    <tr>
            <td>No PRK</td>                    
            <td>
                  <input name="noprk" id="noprk" maxlength="64" size="50" type="text" value="<?=$prk;?>">
        </tr>
      <tr>
		<td>Basket</td>
		<td>
			<input name="basket" id="basket" maxlength="64" size="50" type="text" value="<?=$basket;?>">
		</td>
      </tr>
      <tr>
		<td>Fungsi
		...
		<td>
			<input name="fungsi_val" id="fungsi_val" maxlength="64" size="50" type="text" value="<?=$fungsi_val;?>">
		</td>
      </tr>
      <tr>
            <td align="center">
		   ...
		   <tr>
            <td>Nomor SKKI</td>                
            <td><input name="noskko" id="noskko" maxlength="64" size="50" type="text" value="<?=$noskki;?>" readonly />
            </td>
        </tr>   
        <tr>
            <td>Uraian</td>                    
            <td><textarea name="uraian" id="uraian" rows="3" cols="50"><?=$uraian;?></textarea>
            </td>
        </tr>
        <tr>
            <td>Tgl Terbit SKKI</td>                  
            <td><input name="tgl_skko" id="tgl_skko" type="text" size="50" value="<?=$tgl_skki;?>"></td>
            </tr>  
        <tr>
            <td>
				Data Aset Manajemen
            ...
            <td> <!-- <textarea name="aset" id="aset" rows="3" cols="50"></textarea> -->
				<table border="0">
					...
					<tr>
						...
						<td><input type="text" name="jtma" id="jtma" value="<?=$jtma;?>"></td>
						<td><input type="text" name="jtmd" id="jtmd" value="<?=$jtmd;?>"></td>
					</tr>
					<tr>
						<td>GD</td>
						<td><input type="text" name="gd" id="gd" value="<?=$gd;?>"></td>
						<td><input type="text" name="gda" id="gda" value="<?=$gd;?>"></td>
						<td><input type="text" name="gdd" id="gdd" value="<?=$gd;?>"></td>
					</tr>
					<tr>
						<td>JTR</td>
						<td><input type="text" name="jtr" id="jtr" value="<?=$jtr;?>"></td>
						<td><input type="text" name="jtra" id="jtra" value="<?=$jtr;?>"></td>
						<td><input type="text" name="jtrd" id="jtrd" value="<?=$jtr;?>"></td>
					</tr>
					<tr>
						<td>SL1</td>
						<td><input type="text" name="sl1" id="sl1" value="<?=$sl1;?>"></td>
						<td><input type="text" name="sl1a" id="sl1a" value="<?=$sl1;?>"></td>
						<td><input type="text" name="sl1d" id="sl1d" value="<?=$sl1;?>"></td>
					</tr>
					<tr>
						<td>SL3</td>
						<td><input type="text" name="sl3" id="sl3" value="<?=$sl3;?>"></td>
						<td><input type="text" name="sl3a" id="sl3a" value="<?=$sl3;?>"></td>
						<td><input type="text" name="sl3d" id="sl3d" value="<?=$sl3;?>"></td>
					</tr>
					<tr>
						<td>Key Point</td>
						<td><input type="text" name="kp" id="kp" value="<?=$kp;?>"></td>
						<td><input type="text" name="kpa" id="kpa" value="<?=$kpa;?>"></td>
						<td><input type="text" name="kpd" id="kpd" value="<?=$kpd;?>"></td>
					</tr>
				</table>
            </td>
        </tr>
        <tr>
            <td>Nilai Tunai</td>                    
            <td>            
            <input value="<?=$tunai;?>" name="tunai" id="tunai" maxlength="64" size="50" type="text" onchange="anggaranval();" /> <!--onchange="formatme(this)"-->
            </td>
        </tr>
        <tr>
            <td>Nilai Non Tunai</td>                    
            <td>            
            <input value="<?=$nontunai;?>" name="nontunai" id="nontunai" maxlength="64" size="50" type="text" onchange="anggaranval();" /> <!--onchange="formatme(this)"-->
            </td>
        </tr>
        <tr>
            <td>Nilai Anggaran</td>                    
            <td>            
            <input value="<?=$anggaran;?>" name="anggaran" id="anggaran" maxlength="64" size="50" type="text" readonly /> <!--onchange="formatme(this)"-->
            </td>
        </tr>
        <tr>
            <td>Nilai Disburse</td>                    
            <td>            
            <input value="<?=$disburse;?>" name="disburse" id="disburse" maxlength="64" size="50" type="text" readonly /> <!--onchange="formatme(this)"-->
            </td>
        </tr>
		<tr>
            <td>No WBS</td>                    
            <td>            
            <input value="<?=$nowbs;?>" name="nowbs" id="nowbs" maxlength="64" size="50" type="text" />
            </td>
        </tr> 
        <tr>
            <td>Nilai WBS</td>                    
            <td>            
            <input value="<?=$wbs;?>" name="wbs" id="wbs" maxlength="64" size="50" type="text" /> <!--onchange="formatme(this)"-->
            </td>
        </tr>                         
