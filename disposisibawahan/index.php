...
<?php
	...
	$sql = "
		SELECT 	n.nomornota as nomornota, n.tanggal, n.perihal, n.skkoi as skkoi, n.nilaiusulan, n.progress as progress, n.nip,
				n.assigndt, n.nipuser, p.pid, p.info, p.keterangan, u.nama, u.kdunit as unitanggaran, u.bidang, u.adm
		FROM 	notadinas n LEFT JOIN 
				progress p ON COALESCE(n.progress, 0) = p.pid LEFT JOIN 
				user u on n.nip=u.nip 
		WHERE 	COALESCE(progress,0) < 8 and COALESCE(progress,0) != 1 ".($nip == "6793235Z" ? "" : " AND n.nip = '$nip'" )."
		$parm
