		...
		echo "
			...
			<table>
				<tr>
					...
					<td>:</td>
					<td><input type='month' name='p1' id='p1' value='".(empty($p1)? date("Y-01") : $p1 )."'> - <input type='month' name='p2' id='p2' value='".(empty($p2)? date("Y-m") : $p2 )."'></td>
				</tr>
				...
				<tr>
					<td colspan='3' align='right'>
						<input type='button' id='filter' value='View'>
			...
			var table = $('#dataTables').DataTable({
				...
				ajax: {
					...
					"data": function ( d ) {
						...
						d.p2 = $("[name='p2']").val();
						d.b = $("[name='bidang']").val();
						d.p = $("[name='pelaksana']").val();
						d.k = $("[name='skk']").val();
						d.kpos = $("[name='kdpos']").val();
					}
				},
				"columns": [
					{ data: 'skki.no_urut', name: 'no_urut', searchable: false },
					{ data: 'skki.nowbs', name: 'nowbs' },
					{ data: 'skki.nomornota', name: 'nomornota' },
					{ data: 'skki.noskk', name: 'noskk' },
					{ data: 'skki.uraians', name: 'uraians' },
					{ data: 'skki.tanggalskki', name: 'tanggalskki' },
					{ data: 'skki.anggaran', name: 'anggaran', searchable: false },
					{ data: 'skki.disburse', name: 'disburse', searchable: false },
					{ data: 'skki.wbs', name: 'wbs', searchable: false },
					{ data: 'pos.pos1', name: 'pos1' },
					{ data: 'pos.namapos', name: 'namapos' },
					{ data: 'pos.nilai1', name: 'nilai1', searchable: false },
					{ data: 'skki.namaunit', name: 'namaunit', searchable: false },
					{ data: 'skki.jtm', name: 'jtm', searchable: false },
					{ data: 'skki.nilaianggaranjtm', name: 'nilaianggaranjtm', searchable: false },
					{ data: 'skki.gd', name: 'gd', searchable: false },
					{ data: 'skki.nilaianggarangd', name: 'nilaianggarangd', searchable: false },
					{ data: 'skki.jtr', name: 'jtr', searchable: false },
					{ data: 'skki.nilaianggaranjtr', name: 'nilaianggaranjtr', searchable: false },
					{ data: 'skki.sl1', name: 'sl1', searchable: false },
					{ data: 'skki.nilaianggaransl1', name: 'nilaianggaransl1', searchable: false },
					{ data: 'skki.sl3', name: 'sl3', searchable: false },
					{ data: 'skki.nilaianggaransl3', name: 'nilaianggaransl3', searchable: false },
					{ data: 'skki.keypoint', name: 'keypoint', searchable: false },
					{ data: 'skki.nilaianggarankp', name: 'nilaianggarankp', searchable: false },
					{ data: 'kontrak.no_rab', name: 'no_rab' },
					{ data: 'kontrak.nilai_rp', name: 'nilai_rp', searchable: false },
					{ data: 'kontrak.nomorkontrak', name: 'nomorkontrak' },
					{ data: 'kontrak.nodokumen', name: 'nodokumen' },
					{ data: 'kontrak.vendor', name: 'vendor' },
					{ data: 'kontrak.uraiank', name: 'uraiank' },
					{ data: 'kontrak.tglawal', name: 'tglawal' },
					{ data: 'kontrak.tglakhir', name: 'tglakhir' },
					{ data: 'kontrak.kontrak', name: 'kontrak', searchable: false },
					{ data: 'kontrak.bayar', name: 'bayar', searchable: false },
					{ data: 'pos.sisadisburse', name: 'sisadisburse', searchable: false },
					{ data: 'kontrak.sisabayar', name: 'sisabayar', searchable: false },
					{ data: 'kontrak.jtmaset', name: 'jtmaset', searchable: false },
					{ data: 'kontrak.jtmrp', name: 'jtmrp', searchable: false },
					{ data: 'kontrak.gdaset', name: 'gdaset', searchable: false },
					{ data: 'kontrak.gdrp', name: 'gdrp', searchable: false },
					{ data: 'kontrak.jtraset', name: 'jtraset', searchable: false },
					{ data: 'kontrak.jtrrp', name: 'jtrrp', searchable: false },
					{ data: 'kontrak.sl1aset', name: 'sl1aset', searchable: false },
					{ data: 'kontrak.sl1rp', name: 'sl1rp', searchable: false },
					{ data: 'kontrak.sl3aset', name: 'sl3aset', searchable: false },
					{ data: 'kontrak.sl3rp', name: 'sl3rp', searchable: false },
					{ data: 'kontrak.keypointaset', name: 'keypointaset', searchable: false },
					{ data: 'kontrak.keypointrp', name: 'keypointrp', searchable: false },
					{ data: 'kontrak.inputdt', name: 'inputdt', searchable: false },
					{ data: 'kontrak.app_pel', name: 'app_pel', searchable: false },
					{ data: 'kontrak.app_ang', name: 'app_ang', searchable: false },
					{ data: 'kontrak.app_keu', name: 'app_keu', searchable: false },
					{ data: 'kontrak.download', name: 'download', searchable: false },
					{ data: 'kontrak.action1', name: 'action1', searchable: false },
					{ data: 'kontrak.action2', name: 'action2', searchable: false }
				]
			});
