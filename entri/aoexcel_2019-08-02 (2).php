	...
	if($v!="") {
		$sql = "
			SELECT	n.nomornota, nipuser, pelaksana, b.namaunit, pos1, nilai1, namapos, nomorwbs, nomorcostcenter, 
					...
					nilaiwbs wbs, date(k.tgltagih) as tgltagih, kt.nama as name_type, inputdt, nomorkontrak, vendor, k.uraian uraiank, 
					tglawal, tglakhir, nilaikontrak kontrak, bayar, kapel.signdt as app_pel, kaang.signdt as app_ang, 
					kakeu.signdt as app_keu 
