<?php
	...
	while ($row = mysqli_fetch_array($query_result)) {
        ...
        // if($v!="") {
            ...
            $sql = "
                ...
                FROM 	(
                        ...
                        (
                            SELECT 	pos, SUM(nilaikontrak) kontrak, SUM(nilaibayar) bayar
                            FROM 	(
        ...
        $htmlcontent = '
            <p><span style="font-family: verdana, geneva;">Dengan Hormat,</span></p>
			<p style="text-align: justify;"><span style="font-family: verdana, geneva;">Disampaikan realisasi penyerapan anggaran untuk pelaksanaan SKKI dan SKKO. </span><span style="font-family: verdana, geneva;">Per Sub Pos di Unit masing-masing,&nbsp; mohon dapat di Evaluasi realisasi tekontrak dan terbayar. </span><span style="font-size: 11pt; font-family: verdana, geneva;">Jika ada data yang kurang cocok agar dikomunikasikan dengan PIC Anggaran atau PIC Keuangan.</span></p>
			<p style="text-align: justify;"><span style="font-size: 11pt; font-family: verdana, geneva;">Rincian Kontrak dapat dilihat pada :</span></p>
			<ul>
			...
			<p style="text-align: center;"><span style="font-size: 11pt; font-family: verdana, geneva;">PIC ANGGARAN DAN KEUANGAN</span></p>
			<p style="text-align: center;"><span style="font-size: 11pt; font-family: verdana, geneva;">APLIKASI MONITA</span></p>
			...
			<p><span style="font-size: 11pt; font-family: verdana, geneva;">Demikianlah atas&nbsp; perhatiannya di Ucapkan terimakasih</span></p>
			<p>&nbsp;</p>
			<p><span style="font-size: 11pt; font-family: verdana, geneva;">Salam</span></p>
			<p><span style="font-size: 11pt; font-family: verdana, geneva;">Fadlul Fathoni</span></p>
			<p><span style="font-size: 11pt; font-family: verdana, geneva;">Support Monita</span></p>
			<p><span style="font-size: 11pt; font-family: verdana, geneva;">No. HP: 0896-4464-1591</span></p>
        ';
        ...
        $to         = "";
        $cc         = "Fadlul <fadlul.fathoni@gmail.com>";
        ...
        while ($row_user = mysqli_fetch_array($rslt_user)) {
            ...
            if (!empty($row_user['email'])){
                ...
                if (empty($to)){
					...
					$to .= str_replace('.', ' ', str_replace(',', ' ', $row_user['nama'])) . " <fadlul.fathoni@gmail.com>";
        ...
        while ($row_user = mysqli_fetch_array($rslt_user)) {
            ...
            if (!empty($row_user['email'])){
				...
				$cc .= ", " . str_replace('.', ' ', str_replace(',', ' ', $row_user['nama'])) . " <fadlul.fathoni@gmail.com>";
            }
        }
		
		if (empty($to)){

			$to .= "Fadlul <fadlul.fathoni@gmail.com>";
		...
		// $finfo = finfo_open(FILEINFO_MIME, "conf/magic"); // return mime type ala mimetype extension
        // $mime_type = finfo_file($finfo, $file_path) . "\n";
        // finfo_close($finfo);
		
        // $result = new finfo(FILEINFO_MIME);
		// if (is_resource($result) === true) {
			// $mime_type =  $result->file($file_path);
		// }
		
		// $mime_type = mime_content_type($file_path);
		
        // echo( '<p>mime: ' . $mime_type . '</p> <br /> ');
        
        $mime->addAttachment($file_path); // , $mime_type);
