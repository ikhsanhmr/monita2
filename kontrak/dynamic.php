<?php
	...
	<div id='kontrak$num'>
		...
		<table border='1'>
			<tr>
				<td colspan='3'><input type='button' value='-' onClick='hapuskontrak(\"kontrak$num\")'></td>				
			</tr>
			<tr>
				<td colspan='3'><input type='checkbox' name='peti$num' id='peti$num'>Kontrak Petty Cash</td>				
			</tr>
			<tr>
				<td>Nomor Kontrak</td>
				<td>&nbsp;:&nbsp;</td>
			...
			<tr>
				<td>Nomor Dokumen</td>
				<td>&nbsp;:&nbsp;</td>
				<td><input required size='49' type='text' name='nodokumen$num' id='nodokumen$num' required></td>
			</tr>
			<tr>
			...
			<tr>
				<td>Bulan Tagih</td>
				<td>&nbsp;:&nbsp;</td>
				<td><input required size='22' type='" . ($nice? "date": "text") . "' name='tgltagih$num' id='tgltagih$num' " . ($nice? "": "onChange='dateCheck(\"tgltagih$num\")' ") . "value=''></td>
			</tr>
			<tr>
				<td>Nilai Kontrak</td>
				<td>&nbsp;:&nbsp;</td>
